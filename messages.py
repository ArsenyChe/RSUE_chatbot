...
/editintent <тема> <новыое наименование темы> Изменяет тему  с пустыми шаблонами вопросов и ответами на вопросы
/addpattern <тема> <вопрос>	Добавляет шаблоны вопросов для темы
/delpattern <тема> <вопрос>	Удаляет шаблоны вопросов для темы
/addresponse <тема> <вопрос> Добавляет ответы для темы
/delresponse <тема> <вопрос> Удаляет ответы для темы
