...
/show_questions [ОТ ДАТЫ] [ДО ДАТЫ] [РЕАКЦИЯ НА ОТВЕТ НЕЙРОСЕТИ]- Эта команда позволяет вывести в чат вопросы пользователей за определенный период времени (формат даты %Y-%m-%d). Например, /show_questions 2024-05-04  2024-05-04 True выведет все вопросы пользователей за указанный период, на которые нейросеть ответила правильно.
/nn_training
/add_intent
/delete_intent
/output_dataset
